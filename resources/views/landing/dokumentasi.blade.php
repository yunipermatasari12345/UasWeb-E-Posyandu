...
<head>
    ...
    <title>Dokumentasi - Yuni Permata Sari MI2C</title>
...
<body class="bg-gray-50">
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8">
                ...
                <a href="{{ route('dokumentasi') }}" class="text-blue-600 font-bold">Dokumentasi</a>
    ...
    <main class="container mx-auto px-4 py-16">
        <h2 class="text-3xl font-bold text-gray-800 mb-6">Dokumentasi Kegiatan</h2>
        <div class="bg-white rounded-lg shadow p-8 text-gray-600">
            <p>Belum ada dokumentasi yang ditampilkan. Konten akan segera hadir.</p>
        </div>
    </main>
</body>
</html>
